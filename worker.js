...
userQueue.process(async (job, done) => {
  ...
  try {
    ...
    const mailContent = [
      ...
      'Welcome to <a href="https://github.com/Dayvid0063/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file management API built with Node.js by ',
      '<a href="https://github.com/Dayvid0063/alx-files_manager">Orji David & Geitodyu Henrique Crusoe</a>. ',
